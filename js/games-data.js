...
const juegos = [
  ...
  { id:"game-015", nombre:"Gordo Runner",        categoria:"accion",       tags:["correr","saltar","gordo","ciudad"],     thumbnail:"", embed_url:"games/juego-local-5.html",  descripcion:"Saltá la comida chatarra. El personaje adelgaza a medida que avanzás.",    tipo:"local" },
